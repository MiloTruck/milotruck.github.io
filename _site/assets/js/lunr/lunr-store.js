var store = [{
        ...
        "excerpt":"An online international CTF competition for high-school students. I played with my regular teammates in ItzyBitzySpider under the name acsii. We managed to get 12th place, which originally meant we qualified for the onsite finals hosted in Timisoara, Romania, but the competition was cancelled in the end… :( Writeups Hiss...","categories": ["CTF"],
        "tags": [],
        "url": "http://localhost:4000/ctf/Timisoara-CTF-2019-Qualifiers/",
        "teaser":null},{
        "title": "HATS CTF",
        "excerpt":"Some writeups for an internal CTF hosted by some seniors in HATS SG. Managed to place first in the end, which I’m quite happy about. Writeups babyvm-re (reversing) You have stumbled across a interesting piece of code with seemingly random letters and numbers, can you help find what the key...","categories": ["CTF"],
        "tags": [],
        "url": "http://localhost:4000/ctf/HATS-CTF/",
        "teaser":null},{
        "title": "Cyberthon 2020",
        "excerpt":"A local Singaporean CTF organized by HCI for JC students, in collaboration with DCO and CSIT. I participated with my teammates in ItzyBitzySpider, under the name acsi-1. We managed to place 3rd in the end, and were also awarded Winner of Data Science Category for the most challenge in the...","categories": ["CTF"],
        "tags": [],
        ...
        "excerpt":"A local Singaporean CTF hosted by GovTech, where we managed to place 3rd under the name ItzyBitzySpider. I participated in this CTF with my regular teammates in the JC category, @jloh02, @OceanKoh, @NyxTo. Many of the writeups below were written by them, so credits to them. Challenge Writeups Reversing An...","categories": ["CTF"],
        "tags": [],
        "url": "http://localhost:4000/ctf/Stack-the-Flags-2020/",
        "teaser":null},{
        "title": "Unlock Me [905]",
